...
public class C0833xe6e79f6<T> extends AbstractC1388a {
    public C0833xe6e79f6() {
    }

    @Override // p144x.AbstractC1388a
    /* renamed from: e */
    public final /* synthetic */ boolean mo2100e(View view) {
    ...
    public C0833xe6e79f6(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC1395a.f6037f);
